 ...
 * Bylines credit the in-house Garg Brothers Immigration Team (Organization schema).
...
export const SITE = "https://www.gargbrothers.ca";
...
export const authors: Record<string, Author> = {
  "sahil-garg": {
    ...
    organization: "Garg Brothers",
    yearsExperience: 12,
    shortBio:
      "The Garg Brothers Immigration Team has 12+ years combined experience guiding skilled professionals, students and families through Canadian, Australian, UK and German immigration pathways.",
    bio:
