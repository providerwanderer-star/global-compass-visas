...
const TermsPage = () => (
  <div className="min-h-screen bg-background">
    <Helmet>
      <title>Terms of Service | Garg Brothers</title>
      <meta name="description" content="Terms governing your use of the Garg Brothers website, educational content, calculators, and consultation requests." />
      <link rel="canonical" href="https://www.gargbrothers.ca/terms" />
    </Helmet>
    <div className="container mx-auto max-w-3xl px-4 py-16 prose prose-slate">
      <h1>Terms of Service</h1>
      <p><em>Last updated: July 2026</em></p>

      <p>By accessing www.gargbrothers.ca you agree to these Terms. If you do not agree, please do not use the site.</p>
      ...
      <p>Site content, branding, and layouts are owned by Garg Brothers. You may share links freely; reproducing substantial content requires written permission.</p>
      ...
      <p>To the fullest extent permitted by law, Garg Brothers is not liable for any indirect, incidental, or consequential loss arising from use of this site or reliance on its content.</p>
