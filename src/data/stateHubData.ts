...
export const stateHubs: StateHub[] = [
  {
    ...
    parentPath: "/india",
    parentLabel: "India",
    metaTitle: "Best Immigration Consultant in Gujarat | Canada PR, Study & Work Visa – Garg Brothers",
    ...
    intro: "Gujarat's entrepreneurial spirit drives thousands of professionals and business owners to explore immigration every year. Whether you're an IT professional in Ahmedabad, a diamond trader in Surat, or an engineer in Vadodara — Garg Brothers provides expert immigration guidance tailored to Gujarat applicants across Canada, Australia, Germany & UK.",
    stats: [
    ...
    faqs: [
      { question: "Who is the best immigration consultant in Gujarat?", answer: "Garg Brothers is rated among the top immigration consultants serving Gujarat, with a 98% success rate. We serve Ahmedabad, Surat, Vadodara, Rajkot, and Gandhinagar with personalized immigration strategies." },
      { question: "How much does Canada PR cost from Gujarat?", answer: "Canada PR costs from Gujarat include government fees (CAD 1,365), IELTS (~₹16,000), WES (~₹15,000), and consulting fees. Total is typically ₹3-5 lakhs. Garg Brothers offers transparent all-inclusive packages." },
      ...
      { question: "Is Canada Start-Up Visa good for Gujarat business owners?", answer: "Yes! Canada's Start-Up Visa is ideal for Gujarat entrepreneurs. You need a letter of support from a designated Canadian organization, proof of funds, and language proficiency. Garg Brothers guides you through the entire process." }
    ],
  },
  {
    slug: "haryana",
    ...
    parentPath: "/india",
    parentLabel: "India",
    metaTitle: "Best Immigration Consultant in Haryana | Canada PR, Express Entry & LMIA – Garg Brothers",
    ...
    intro: "Haryana's NCR corridor and industrial cities produce thousands of skilled professionals eligible for international immigration every year. From Gurugram's corporate executives to Faridabad's engineers and Ambala's defence sector professionals — Garg Brothers helps Haryana residents navigate the best pathways to Canada, Australia, Germany & UK.",
    stats: [
    ...
    faqs: [
      { question: "Who is the best immigration consultant in Haryana?", answer: "Garg Brothers is a top-rated consultant serving Haryana with 98% success rate. We help professionals from Gurugram, Faridabad, Ambala, Karnal, and Panipat with Canada PR, work permits, and study visas." },
      { question: "Can I get Canada PR from Gurugram?", answer: "Yes! Gurugram professionals in IT, finance, and management consistently qualify for Express Entry. Many score 460+ CRS with proper optimization. Book a free assessment with Garg Brothers." },
  ...
  },
  {
    ...
    parentPath: "/india",
    parentLabel: "India",
    metaTitle: "Best Immigration Consultant in Rajasthan | Canada PR, Work Visa & Study Permit – Garg Brothers",
    ...
    intro: "Rajasthan's growing IT sector, world-class educational institutions, and hospitality industry produce thousands of immigration-eligible professionals. From Jaipur's tech corridor to Kota's engineering graduates and Udaipur's hospitality managers — Garg Brothers helps Rajasthan residents find the fastest pathway to Canada, Australia, Germany & UK.",
    stats: [
    ...
    faqs: [
      { question: "Who is the best immigration consultant in Rajasthan?", answer: "Garg Brothers is a top-rated immigration consultant serving Rajasthan with 98% success rate. We help professionals from Jaipur, Jodhpur, Udaipur, and Kota with Canada PR, study visas, and work permits." },
  ...
  },
  {
    ...
    parentPath: "/canada",
    parentLabel: "Canada",
    metaTitle: "Immigration Services in Ontario | PR, LMIA, Family Sponsorship & PNP – Garg Brothers",
    ...
    faqs: [
      ...
      { question: "How can I sponsor my parents from Ontario?", answer: "As a Canadian PR or citizen in Ontario, you can apply during the annual Parents and Grandparents Program (PGP) intake. Super Visa is an alternative for extended visits. Garg Brothers handles both pathways." },
  ...
  },
  {
    ...
    parentPath: "/canada",
    parentLabel: "Canada",
    metaTitle: "Immigration Services in British Columbia | BC PNP, PR & Work Permits – Garg Brothers",
