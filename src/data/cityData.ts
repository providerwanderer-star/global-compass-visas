...
const indianCityInsights: Record<string, string> = {
  ...
  "Bathinda": "Bathinda (Bhatinda) is a major agricultural and industrial centre in southern Punjab with a rapidly growing population of immigration aspirants. The city's proximity to Chandigarh and established IELTS coaching centres help applicants achieve CLB 7+. Bathinda's strong farming and small-business community frequently explores LMIA-based work permits and Express Entry pathways to Canada.",
  "Patiala": "Patiala, the royal city of Punjab, is an emerging immigration hub with a strong education sector anchored by Thapar Institute and Punjabi University. Young graduates from Patiala increasingly pursue study-to-PR pathways in Canada. The city's Punjabi diaspora connections in Ontario and BC create strong family sponsorship and LMIA pipelines.",
  "Hoshiarpur": "Hoshiarpur district in Punjab's Doaba region has one of India's highest per-capita rates of Canadian immigration. Known as 'Mini Canada,' Hoshiarpur families have multi-generational ties to BC and Ontario. The city's NRI community drives strong demand for family sponsorship, LMIA work permits, and Express Entry applications.",
  "Moga": "Moga, a key city in Punjab's Malwa region, has seen a surge in immigration applications driven by its agricultural and dairy industry professionals. Many Moga residents have family in Canada's prairie provinces, creating strong sponsorship pathways. The city's growing IELTS preparation ecosystem helps applicants achieve competitive CRS scores.",
  "Pathankot": "Pathankot, at the northern tip of Punjab bordering Himachal Pradesh and Jammu, has a growing immigration-ready workforce in defence services, education, and healthcare. The city's strategic location means applicants access VFS centres in both Chandigarh and Jammu. Pathankot professionals increasingly qualify for Express Entry and PNP pathways.",
...
const canadianCityInsights: Record<string, string> = {
  ...
  "Scarborough": "Part of Toronto's east end, Scarborough has one of Canada's most diverse immigrant populations. Strong South Asian, Tamil, and Chinese communities create extensive settlement networks. Scarborough's transit expansion and affordable housing compared to downtown Toronto make it a top choice for newcomers seeking Ontario PNP eligibility.",
  "Milton": "One of Canada's fastest-growing towns, Milton in Halton Region attracts young immigrant families with its excellent schools and affordable housing. Milton's distribution and logistics sector creates consistent LMIA opportunities, while proximity to Toronto and Hamilton opens multiple employment pathways for newcomers.",
  "Waterloo": "Home to the University of Waterloo and a thriving tech ecosystem, Waterloo attracts skilled immigrants in software engineering, AI, and quantum computing. The Waterloo Region's Ontario PNP Tech stream frequently targets tech professionals, and the city's startup culture offers entrepreneurial immigration pathways.",
