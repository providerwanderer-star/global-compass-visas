    ...
    <footer className="bg-primary text-cream">
      <div className="container-narrow mx-auto section-padding">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={l.href}>
                  <Link to={l.href} className="text-sm text-cream/60 hover:text-gold transition-colors">{l.label}</Link>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-cream/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-cream/40">© 2026 4 Aces Visa. All rights reserved.</p>
          <div className="flex gap-6">
            <Link to="/privacy" className="text-sm text-cream/40 hover:text-gold transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="text-sm text-cream/40 hover:text-gold transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
