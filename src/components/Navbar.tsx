...
const navLinks: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "🌾 Saskatchewan PNP", href: "/canada-pnp/saskatchewan" },
      { label: "⚜️ Quebec (QSWP / PEQ)", href: "/canada-pnp/quebec" },
      { label: "🦞 Atlantic (NS · NB · PEI · NL)", href: "/canada-pnp/nova-scotia" },
      { label: "💼 Work Permits & LMIA", href: "/services/work-permits" },
      { label: "🎓 Study → PR Hub", href: "/study-to-pr" },
      { label: "❤️ Caregiver Pathway", href: "/caregiver-pathway" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "💵 IRCC Fees Calculator", href: "/tools/ircc-fees" },
