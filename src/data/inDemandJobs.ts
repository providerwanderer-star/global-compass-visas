...
export const inDemandJobs: InDemandJob[] = [
  ...
  {
    slug: "nurse-aide-psw",
    title: "Nurse Aide / Orderly (Hospital PSW)",
    noc: "33102",
    teer: 3,
    industry: "Healthcare",
    ...
    summary: "Hospital and long-term care PSWs (NOC 33102, TEER 3) qualify for Express Entry CEC + Healthcare category. Home-based caregivers should look at NOC 44101 + Home Care Worker Pilot.",
  ...
  },
  {
    ...
    title: "Early Childhood Assistant (ECA)",
    noc: "42202",
    teer: 3,
    industry: "Education",
    salaryLow: 35000, salaryHigh: 50000,
    demand: "Very High",
    provinces: ["Ontario", "British Columbia", "Alberta", "Manitoba"],
    pathways: ["Express Entry — CEC", "Category-based: Education", "PNP — Ontario (OINP)", "PNP — BC PNP"],
    summary: "ECAs share NOC 42202 with ECEs and are Express Entry eligible. The 2025 Education category draws cover both roles — fastest PR route in the childcare sector.",
    studyPathways: ["ECA Certificate (1-year)", "ECE Diploma (bridging to RECE)"],
    liveJobQuery: "early childhood assistant",
  },
  {
