...
const indianCities: CityData[] = [
  ...
  return {
    ...
    region,
    metaTitle: hasState
      ? `Best Immigration Consultant in ${name}, ${stateLabel} | Canada PR, LMIA & Study Visa – Garg Brothers`
      : `Best Immigration Consultant in ${name} | Canada, Australia & Germany PR – Garg Brothers`,
    metaDescription: hasState
      ...
      : `Looking for a trusted immigration consultant in ${name}? Garg Brothers helps with Canada PR, Australia migration, Germany work visa, study permits & more. Free assessment.`,
    intro: hasState
      ? `If you're in ${name}, ${stateLabel} looking to immigrate, Garg Brothers is your trusted partner. We offer expert guidance for Canada Express Entry, LMIA work permits, PNP applications, study permits, and more. Our ${name} specialists have helped hundreds of ${stateLabel} families achieve their immigration goals with a 98% success rate.`
      : `Are you in ${name} and dreaming of settling abroad? Garg Brothers is your trusted immigration partner in ${name}, offering expert guidance for Canada PR, Australia skilled migration, and Germany Job Seeker Visa. Our ${name} team has helped hundreds of local professionals and families achieve their global immigration goals with a 98% success rate.`,
    ...
    testimonial: {
      ...
      text: `Garg Brothers made my Canada PR journey seamless. From document prep in ${name} to landing in Canada — every step was guided perfectly.`,
      visa: "Canada PR",
    },
    faqs: [
...
const canadianCities: CityData[] = [
  ...
  return {
    ...
    metaTitle: `Immigration Services in ${name} | PR, Work Permit & Sponsorship – Garg Brothers`,
    metaDescription: `Need immigration help in ${name}? Garg Brothers offers PR applications, work permits, family sponsorship, and citizenship guidance in ${name}. Free consultation.`,
    intro: `Welcome to Garg Brothers ${name} — your local immigration partner for all visa and PR needs. Whether you're a newcomer looking to extend your status, sponsor your family, or transition from a work permit to permanent residency, our ${name} team provides hands-on guidance every step of the way.`,
    ...
    testimonial: {
      name: `Client in ${name}`,
      text: `The ${name} team at Garg Brothers helped me sponsor my parents. The entire process was smooth and stress-free. Highly recommended!`,
