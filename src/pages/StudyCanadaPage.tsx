...
const StudyCanadaPage = () => {
  ...
  const metaTitle = `${g.shortName} ${YEAR} — Rules, Process & Fees | 4 Aces Visa`;
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="mx-auto max-w-3xl">
            <div className="mb-6 text-center">
              ...
              <p className="mt-2 text-muted-foreground">Sahil Garg's team helps international students choose PGWP-eligible programs and lock in PR pathways. Book a free consult.</p>
            </div>
