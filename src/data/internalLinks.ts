...
export const blogToServices: Record<string, string[]> = {
  ...
  "canada-pr-processing-time-timeline-2026": ["express-entry", "pnp-application", "work-permits"],
  "canada-pr-without-ielts-alternatives-2026": ["express-entry", "pnp-application", "student-visa"],
  "canada-work-permit-process-step-by-step-2026": ["work-permits", "lmia-assistance", "express-entry"],
  "employer-sponsorship-canada-lmia-guide-2026": ["lmia-assistance", "work-permits", "express-entry"],
  "pr-through-work-permit-canada-2026": ["work-permits", "express-entry", "pnp-application"],
  ...
  "immigration-consultant-bathinda-punjab-2026": ["express-entry", "lmia-assistance", "student-visa"],
  "scarborough-immigration-services-2026": ["express-entry", "family-sponsorship", "work-permits"],
  "hamilton-immigration-consultant-guide-2026": ["express-entry", "pnp-application", "lmia-assistance"],
};
...
export const cityToLinks: Record<string, { blogs: string[]; services: string[] }> = {
  ...
  bathinda: { blogs: ["immigration-consultant-bathinda-punjab-2026", "canada-pr-process-from-punjab-2026"], services: ["express-entry", "lmia-assistance"] },
  patiala: { blogs: ["canada-pr-process-from-punjab-2026", "sds-vs-non-sds-canada-study-visa-2026"], services: ["student-visa", "express-entry"] },
  hoshiarpur: { blogs: ["canada-pr-process-from-punjab-2026", "employer-sponsorship-canada-lmia-guide-2026"], services: ["family-sponsorship", "lmia-assistance"] },
  moga: { blogs: ["canada-pr-process-from-punjab-2026", "lmia-jobs-canada-from-india-2026"], services: ["express-entry", "work-permits"] },
  pathankot: { blogs: ["canada-pr-eligibility-requirements-2026", "canada-pr-process-from-punjab-2026"], services: ["express-entry", "pnp-application"] },
  // Ontario cities
  ...
  scarborough: { blogs: ["scarborough-immigration-services-2026", "best-colleges-ontario-international-students-2026"], services: ["express-entry", "family-sponsorship"] },
  milton: { blogs: ["ontario-pnp-guide-2026", "canada-work-permit-process-step-by-step-2026"], services: ["pnp-application", "work-permits"] },
  waterloo: { blogs: ["best-colleges-ontario-international-students-2026", "ontario-pnp-guide-2026"], services: ["student-visa", "pnp-application"] },
  hamilton: { blogs: ["hamilton-immigration-consultant-guide-2026", "ontario-pnp-guide-2026"], services: ["express-entry", "pnp-application"] },
  kitchener: { blogs: ["best-colleges-ontario-international-students-2026", "ontario-pnp-guide-2026"], services: ["student-visa", "pnp-application"] },
